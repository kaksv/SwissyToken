...
//     <div className='App'>
//       <header className='App-header'>
//         <h1 className='new-header'>Know your Token Details</h1>
...
//           {/*Display the results*/}
//             <div className='result'>
//               <p className='result-out'><strong>Name:</strong> {name || '--' }</p>
//               <p className='result-out'><strong>Symbol:</strong> {symbol }</p>
//               <p className='result-out'><strong>Total Supply:</strong> {totalSupply }</p>
//             </div>
//           </>
//         )}
//       </header>
